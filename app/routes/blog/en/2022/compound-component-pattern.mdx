...
snippet: "A flexible component authoring pattern to give consumers a composition-based API"
...
Compound components are components that share a common context to work together to perform one or more given task(s).
