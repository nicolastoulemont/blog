...
snippet: "Exploring how Typescript and GraphQL can be combined across a React / Node stack to give full stack observability, automatically generated documentation and a productivity boost with automatic code generation"
description: "Exploring how Typescript and GraphQL can be combined accross a React / Node stack to give unparallel full stack observability, automatic documentation and a productivity boost with automatic code generation"
...
<PostIntro publishedAt="Jan 18th 2021" category="GraphQL" />
...
export const userById = queryField("userById", {
  ...
  async resolve(_, args) {
    ...
    if (!user) {
      return {
        errors: [{ key: "notFound", message: `No user matching the id: ${args.id} was found` }],
      }
    }
