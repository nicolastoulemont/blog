...
import { Heading, Image, Link, OrderedList, UnorderedList, ListItem, Text, useColorModeValue } from '@chakra-ui/react'
...
export const mdxDefaultComponentsRegistry = {
  ...
  a: (props) => {
    ...
    return <Link as='a' color={color} fontWeight={600} textDecoration='underline' {...props} isExternal={true} />
  },
  img: (props) => <Image rounded='md' margin='0 auto' my={3} {...props} src={props.src} fallbackSrc={props.src} />,
  ol: (props) => (
