...
![A library tightly coupled to a UI framework](~/assets/tight-coupling-framework-lib.png)
...
![UI frameworks connected to a shared library core through adapters](~/assets/core-adapters-consumers.png)
...
![The TanStack website and its open-source libraries](~/assets/tan-stack.png)
