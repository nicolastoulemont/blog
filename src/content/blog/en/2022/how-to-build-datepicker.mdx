...
categories:
  ...
  - 'Animations'
locale: 'en'
ogImage: '/img/calendrier.png'
---

import { Container, DatePickerDemo } from '~/components'
...
<Container>
  <DatePickerDemo client:visible={{ rootMargin: '200px' }} />
</Container>

[Source code if you want to skip the post](https://github.com/nicolastoulemont/blog/tree/main/src/components/react/DatePicker/DatePicker.tsx)
...
We will mostly focus on the UI code _(it would be too long otherwise)_, for the utility functions please read the [source](https://github.com/nicolastoulemont/blog/tree/main/src/components/react/DatePicker/DatePicker.tsx).
...
so for the curious here are the [reducer](https://github.com/nicolastoulemont/blog/tree/main/src/components/react/DatePicker/components/Provider/reducer.ts),
[context](https://github.com/nicolastoulemont/blog/tree/main/src/components/react/DatePicker/components/Provider/context.ts)
and [Provider](https://github.com/nicolastoulemont/blog/tree/main/src/components/react/DatePicker/components/Provider/Provider.tsx) files.
...
feel free to take a look at it [yourself](https://github.com/nicolastoulemont/blog/tree/main/src/components/react/DatePicker/components/Input/Input.tsx)
