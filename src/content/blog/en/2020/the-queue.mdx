...
![simple-queue](~/assets/simple-queue.png)
...
![unsorted-priority-queue](~/assets/unsorted-priority-queue.png)
...
![circular-queue](~/assets/circular-queue.jpg)
...
![sorted-priority-queue](~/assets/sorted-priority-queue.png)
