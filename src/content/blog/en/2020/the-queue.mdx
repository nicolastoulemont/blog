...
categories:
  - 'Data Structures'
locale: 'en'
ogImage: '/img/thumbnail-queue.png'
---
...
![A first-in, first-out queue](~/assets/simple-queue.png)
...
![An unsorted priority queue](~/assets/unsorted-priority-queue.png)
...
![A circular queue](~/assets/circular-queue.jpg)
...
![A sorted priority queue](~/assets/sorted-priority-queue.png)
