...
categories:
  - 'Data Structures'
locale: 'en'
ogImage: '/img/thumbnail-linked-list.png'
---
...
![A circular singly linked list](~/assets/circular-singly-linked-list.jpg)
...
![A circular doubly linked list](~/assets/circular-doubly-linked-list.jpg)
