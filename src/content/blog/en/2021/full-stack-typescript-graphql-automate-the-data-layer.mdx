...
![successful code generation console log prints](~/assets/gql-code-gen-success-min.png)
...
![autocomplete from custom hook](~/assets/custom-hook-autocompletion-one-min.png)
![autocomplete from custom hook](~/assets/custom-hook-autocompletion-two-min.png)
...
![unsuccessfull code generation console log prints](~/assets/gql-code-gen-error-min.png)
