...
categories:
  - 'GraphQL'
locale: 'en'
ogImage: '/img/thumbnail-ts-gql.png'
---
...
![GraphQL Code Generator completes successfully and watches for changes](~/assets/gql-code-gen-success-min.png)
...
![Autocomplete for the response returned by useUsersQuery](~/assets/custom-hook-autocompletion-one-min.png)

![Autocomplete for the fields of a user](~/assets/custom-hook-autocompletion-two-min.png)
...
![GraphQL Code Generator catches a misspelled email field](~/assets/gql-code-gen-error-min.png)
