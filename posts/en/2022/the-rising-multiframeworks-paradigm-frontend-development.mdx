...
snippet: 'There is a rising trend of library developed with support to many UI frameworks in the frontend ecosystem. This post acknowledge it and try to explore what it means for the future of frontend development.'
description: 'There is a rising trend of library developed with support to many UI frameworks in the frontend ecosystem. This post acknowledge it and try to explore what it means for the future of frontend development.'
...
After a few years of heavy innovation and diversification in the frontend library space, we may start to see the beginning of a consolidation phase.
...
For some time, tight coupling between UI frameworks and their surrounding ecosystem became the norm.
