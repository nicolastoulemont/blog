...
At first we expect to **loose** between 10-20% of rendering performance by adding the possibility to have responsive styles. We where ok with this trade-off.
