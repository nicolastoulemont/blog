...
export const postsList: Array<PostMetaData> = [
	{
		...
		snippet:
			'Exploring the how Typescript and GraphQL can be combined across a React / Node stack to give full stack observability, automatically generated documentation and a productivity boost with automatic code generation',
