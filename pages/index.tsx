    ...
    <>
      ...
      <MainContainer>
        ...
        <Text
          ...
          mb={{ base: 9, md: 12 }}
        >
          I'm a french full stack software developer. I mainly use and enjoy Typescript, Node, React and GraphQL at the
          moment.
        </Text>
        <Flex width='100%' flexDir='column' align='flex-start' justify='flex-start' my={6} as='section'>
          ...
          <AnimatePresence>
            {filteredPostByCategories.length > 0 ? (
              filteredPostByCategories.map((category) => <Category key={category.category} categoryList={category} />)
            ) : (
