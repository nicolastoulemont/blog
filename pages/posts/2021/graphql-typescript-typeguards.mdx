...
If you found this helpful and want to use these functions, I have packaged them in a npm package called [ts-gql-helpers](https://www.npmjs.com/package/ts-gql-helpers).
